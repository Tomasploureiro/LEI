...
{
       0,    52,    52,    59,    64,    74,    80,    84,    90,   122,
     131,   137,   141,   145,   149,   155,   169,   174,   179,   184,
     189,   198,   209,   216,   220,   225,   231,   237,   243,   253,
     266,   274,   279,   283,   287,   293,   298,   304,   310,   315,
     320,   325,   330,   335,   341,   347,   355,   361,   366,   373,
     378,   384,   391,   397,   403,   409,   415,   421,   428,   434,
     440,   446,   452,   459,   464,   469,   474,   478,   482,   486,
     490,   494
};
#endif
...
#line 91 "gocompiler.y"
                        {
                            ...
                            if((yyvsp[-1].node) != NULL){
                                ...
                                while(cur_var_decl != NULL){
                                    ...
                                    struct node *var_decl_node = cur_var_decl->node;
                                    struct node *id_node = var_decl_node->children->next->node;
                                    char *var_name = my_strdup(id_node->token);
