...
char ip[MAX_CLASSES][16] = {"224.0.0.1", "224.0.0.2", "224.0.0.3", "224.0.0.4", "224.0.0.5", "224.0.0.6", "224.0.0.7", "224.0.0.8", "224.0.0.9"};
...
int init(const char *file){
    // char ipAux[BUFF_SIZE];
    // for(int i = 1; i<MAX_CLASSES;i++){
    //     sprintf(ipAux, "244.0.0.%d", i);
    //     strcpy(ip[i-1], ipAux);
    // }
...
void handleAdmin(int porto_config){
    int sockfd, n = 0;
    int isAdmin;
                    ...
                    while(1){
                        ...
                        if (strcmp(token, "LIST_CLASSES") == 0){
                            ...
                            if (name == NULL || mess == NULL){
                                ...
                                int found = send_message(name, mess);
                                if (found){
                                    strcpy(mensagem, "Mensagem enviada com sucesso\n");
                                }else{
                                    strcpy(mensagem, "Turma inexistente\n");
                                }
                            }
                        }
                        else if (strcmp(token, "EXIT") == 0){
...
int send_message(char *name, char *message){
    int sock;
